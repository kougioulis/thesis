...
\caption{Predicted (non-thresholded) lagged adjacency tensor \(\hat{\mathbb{A}}_{j,i,\ell}\) by the \texttt{9.4}M LCM on the illustrative example, against the ground truth.}
