...
\begin{table}[h]
\centering
\caption{Noise distributions used in synthetic SCMs (fill in as needed).} \label{tab:noise-dists}
\begin{tabular}{lll}
\toprule
